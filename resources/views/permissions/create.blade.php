...
@section('content')
    <h1 class="app-page-title">Permissions</h1>
    <hr class="mb-4">
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            <h3 class="section-title">Ajout</h3>
            <div class="section-intro">Ajouter ici une permission</div>
        </div>
                    ...
                    <form class="settings-form" method="POST" action="{{ route('permissions.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-1"
                                placeholder="Entrer le nom de permission" name="name" value="{{ old('name') }}"
                                required>
